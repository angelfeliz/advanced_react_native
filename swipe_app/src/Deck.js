...
class Deck extends Component {
  ...
  constructor(props) {
    ...
    const panResponder = PanResponder.create({
      ...
      onStartShouldSetPanResponderCapture: (evt, gestureState) => true, // allow movement of the view we'll attach this panResponder to
      onMoveShouldSetPanResponder:(evt, gestureState) => true,
       onMoveShouldSetPanResponderCapture: (evt, gestureState) => true, // allo for dragging the view we'll attach
